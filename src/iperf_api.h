...
#define OPT_GET_REMOTE_RESULTS 3
...
int	iperf_get_test_get_remote_results( struct iperf_test* ipt );
...
void	iperf_set_test_get_remote_results( struct iperf_test* ipt, int remote_results );
